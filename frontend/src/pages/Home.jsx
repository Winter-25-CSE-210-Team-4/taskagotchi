    ...
    return (
        <div className="flex flex-col h-screen w-full min-w-[1024px]">
            ...
            <div className="flex flex-1 bg-white font-inter">
                {/* Sidebar*/}
                <div className="w-1/4 min-w-[250px] bg-gray p-4 flex flex-col border-r border-gray-300">
                    ...
                    <div className="mt-auto flex flex-col gap-2">
                        <button className="btn btn-link text-primary">+ Add Task</button>
                        <button className="btn btn-link text-primary">+ Add Goal</button>
                    </div>
